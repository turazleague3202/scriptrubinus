...
if($user['save'] == 0) {
  echo '<div class=\'content\'><font color=\'#909090\'>Для общения в чате вам нужно сохранить своего персонажа</font></div>';
...
<font color=\'#909090\'>Писать в чат можно с <img src=\'/images/icons/level.png\' alt=\'\'/> 15 уровня</font>   <div class="content">
   ...
   <div class="content">
    ...
    <div class="h-navig"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tbody>            <tr><td class="h-navig-item"><span
            class="active"><a href="/chat">Общий чат</a></span></td><td class="h-navig-item"><a href="/chat/clan">Чат банды</a></td></tr></tbody></table>      </div>
  <div class="line"></div>
...
if($__to['id'] != $user['id']) {
?>
<span  class='small color2'>
<?
    }
?>
|   <a class="small color4" href="/user/<?=$__to['id']?>/"><?=$__to['login']?> </a>
<?
if($__to['id'] != $user['id']) {
?>
</span>
...
| <a href='/adm/bannd/?id=<?=$sender['id']?>'>[бан]</a>
...
?>
  ...
  <div class="dotted"></div>
<ul class="pagination"><li class="next"><?=pages('/chat/'.($_GET['clan'] == true ? 'clan/':'').'?');?></li></ul>
